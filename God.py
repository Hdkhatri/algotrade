...
from fyers import add_signals_and_strikes, create_fyers_session, ema_ribbon_strategy, fetch_and_save_history, fetch_data, get_NextToNextweekThursday, getSymbol
...
# Usage:
df = ema_ribbon_strategy(df)
filename = "God_"+ TIMEFRAME + ".xlsx"
