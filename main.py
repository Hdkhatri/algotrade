...
from fyers import add_signals_and_strikes, create_fyers_session, fetch_and_save_history, fetch_data, get_NextToNextweekThursday, getSymbol
...
for i, row in df.iterrows():
    ...
    if pd.notna(signal) and pd.notna(strike_info):
...
print("✅ Excel with RawData and Result sheets saved as: updated.xlsx")





print("Updated Excel with signals saved as: updated.xlsx")
